...
export const translations = {
  uk: {
    ...
    nav: {
      ...
      consumables: 'Буровий інструмент',
      other: 'Інше'
    },
    hero: {
      slide1: {
    ...
    categories: {
      subtitle: 'ОФІЦІЙНИЙ КАТАЛОГ ОБЛАДНАННЯ',
      title: 'КАТЕГОРІЇ ПРОДУКЦІЇ ДІТЧ ВІТЧ',
      ...
      cat3: { name: 'Електронні системи локацій', desc: 'Високоточні локаційні системи Subsite® (Marksman) та Underground Magnetics (Mag X COR) для безпомилкового ведення буріння.' },
      ...
      cat7: { name: 'Модульна техніка', desc: 'Гусенична модульна техніка з стоячим місцем SK3000 та SK1550 для важких робіт.' },
      ...
      cat10: { name: 'Буровий інструмент', desc: 'Буровий інструмент, оригінальні матеріали Baroid®, розширювачі, бурові головки та компоненти.' },
  ...
  en: {
    ...
    nav: {
      ...
      skidSteers: 'Modular Equipment (Stand-on)',
      ...
      consumables: 'Drill Tools & Consumables',
    ...
    categories: {
      subtitle: 'OFFICIAL EQUIPMENT CATALOG',
      title: 'DITCH WITCH PRODUCT CATEGORIES',
      ...
      cat3: { name: 'Subsite® & Magnetics Locating Systems', desc: 'High-precision Subsite® (Marksman) and Underground Magnetics (Mag X COR) locating systems and beacon sondes.' },
      ...
      cat7: { name: 'Modular Equipment (Stand-on)', desc: 'Heavy-duty SK3000 and SK1550 compact stand-on machines.' },
      cat8: { name: 'American Augers®', desc: 'Heavy HDD rigs and auger boring machinery (Redirects to official site).' },
      cat10: { name: 'Drill Tools & Consumables', desc: 'Original Baroid® bentonites, drill tools, reamers, drill bits, and sondes.' },
  ...
  pl: {
    ...
    nav: {
      ...
      skidSteers: 'Technika Modułowa (Kompaktowa)',
      ...
      consumables: 'Narzędzia Wiertnicze',
      other: 'Inne'
    },
    hero: {
      slide1: {
    ...
    categories: {
      subtitle: 'OFICJALNY KATALOG SPRZĘTU',
      title: 'KATEGORIE PRODUKTÓW DITCH WITCH',
      ...
      cat3: { name: 'Elektronika - systemy lokalizacji Subsite & Magnetics', desc: 'Precyzyjne systemy lokalizacji Subsite® (Marksman) oraz Underground Magnetics (Mag X COR) i sondy.' },
      ...
      cat7: { name: 'Technika Modułowa (Kompaktowa)', desc: 'Kompaktowa technika modułowa SK3000 i SK1550.' },
      cat8: { name: 'American Augers®', desc: 'Ciężkie zestawy wiertnicze (Przekierowanie do oficjalnej strony).' },
      cat10: { name: 'Narzędzia Wiertnicze', desc: 'Oryginalne narzędzia wiertnicze, bentonity Baroid®, poszerzacze i korony.' },
