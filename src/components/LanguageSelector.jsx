...
const FlagUA = () => (
  <svg width="24" height="16" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: '2px', display: 'block', flexShrink: 0, pointerEvents: 'none' }}>
