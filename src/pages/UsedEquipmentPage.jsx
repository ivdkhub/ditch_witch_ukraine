...
export default function UsedEquipmentPage() {
  ...
  const consultantRole = language === 'uk'
    ? 'Консультант з наявності та продажу б/в техніки'
    : language === 'pl'
    ? 'Doradca ds. Sprzętu Używanego Ditch Witch®'
    : 'Pre-Owned Machinery Specialist';
    ...
    <div style={{
      ...
      <div className="container" style={{ marginTop: '40px' }}>
        <div style={{
          ...
          {/* Left Column: Dedicated Contact Person Box (Oleg Lypkyn / Олег Липкин) */}
          <div style={{
          ...
          {/* Right Column: Inquiry & Callback Request Form */}
          <div style={{
            backgroundColor: isDark ? 'rgba(26, 26, 26, 0.85)' : '#FFFFFF',
            borderRadius: '14px',
            padding: '32px',
