...
export default function AboutPage({ onNavigateToProducts }) {
  ...
  const contentData = {
    ...
    stats: [
      ...
      { number: '5', label: { uk: 'Країн Європи', en: 'European Countries', pl: 'Krajów Europy' }, sub: { uk: 'Швеція, Норвегія, Данія, Польща, Україна', en: 'Sweden, Norway, Denmark, Poland, Ukraine', pl: 'Szwecja, Norwegia, Dania, Polska, Ukraina' } },
